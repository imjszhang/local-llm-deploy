...
import SlotOutput from "./SlotOutput.vue";
import {
  availabilityLabels,
  backendLabels,
  capabilityLabels,
    ...
    <div class="drawer-content">
      <template v-if="model">
        <div class="detail-status-strip">
          <a v-if="model.capabilities.includes('chat')" class="text-button" :href="'#/chat?model=' + encodeURIComponent(model.key)" @click="emit('close')">进入对话 ↗</a>
